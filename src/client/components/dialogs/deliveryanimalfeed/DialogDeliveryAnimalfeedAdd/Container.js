...
const propTypes = {
  ...
  submitAddDeliveryAnimalfeed : PropTypes.func,
  open : PropTypes.bool,
...
class DialogDeliveryAnimalfeedAdd extends Component { // eslint-disable-line react/prefer-stateless-function
  state = { ...initState };
  ...
  handleSubmit() {
    const { submitAddDeliveryAnimalfeed } = this.props;
    const { checkedDeliveryAnimalfeed, amount } = this.state;

    submitAddDeliveryAnimalfeed({
...
DialogDeliveryAnimalfeedAdd.propTypes = propTypes;
DialogDeliveryAnimalfeedAdd.defaultProps = defaultProps;

export default injectIntl(connect(modelSelector, containerActions)(DialogDeliveryAnimalfeedAdd));
