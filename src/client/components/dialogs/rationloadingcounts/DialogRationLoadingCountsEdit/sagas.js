...
function* submitEditRationLoadingCounts() {
  // const { name } = action.payload;

  // const data = { };

  try {
    // yield call(serverApi.editRationLoadingCounts, data);
...
export default function* mainSaga() {
  yield takeEvery(actions.DIALOG_RATION_LOADING_COUNTS_SUBMIT, submitEditRationLoadingCounts);
}
