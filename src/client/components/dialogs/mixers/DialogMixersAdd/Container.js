...
const propTypes = {
  ...
  submitAddMixers : React.PropTypes.func,
...
class DialogMixersAdd extends Component { // eslint-disable-line react/prefer-stateless-function
  state = { ...initState };
  ...
  handleSubmit() {
    const { submitAddMixers } = this.props;

    submitAddMixers({ ...this.state });
  }
...
DialogMixersAdd.propTypes = propTypes;
DialogMixersAdd.defaultProps = defaultProps;

export default injectIntl(connect(modelSelector, containerActions)(DialogMixersAdd));
